    ...
    <header className="bg-black-dark px-5  py-10 laptop:px-10">
      <div className="flex items-center justify-between container mx-auto laptop:gap-20 ">
        ...
        <div className="hidden laptop:flex justify-between grow">
          <nav className="flex items-center">
            <ul className="flex gap-16">
              <li className="text-lg font-inter font-normal text-white">
                <a href="" title="" className="hover:text-orange-normal ease-in duration-300">
                  Início
                </a>
              </li>
              <li className="text-lg font-inter font-normal text-white">
          ...
          <button className="text-lg font-inter font-semibold text-white border rounded-[5px] border-white w-[214px] h-[60px] flex justify-center items-center hover:text-orange-normal hover:border-orange-normal ease-in duration-300">Fazer pedido</button>
        </div>
